                                        ...
                                        <!-- <td>
                                            <div class="btn-group pull no-print pull-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li onclick="show_modal_page('<?php //echo base_url().'expense/popup/edit_expense_model/'.$single_expense->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> View details</a>
                                                    </li>
                                                    <li><a onclick="confirmation_alert('delete this','<?php // echo base_url().'expense/delete/'.$single_expense->id; ?>')"  href="javascript:void(0)"  href="#"><i class="fa fa-trash-o"></i> Delete</a>
                                                    </li>
